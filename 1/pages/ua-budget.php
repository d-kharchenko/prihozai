...
<body>
	<div class="uk-container">
			...
			<nav class="uk-navbar-container main-nav" uk-navbar style="position: relative; z-index: 980;">
				<div class="uk-navbar-left ">
				    ...
				    <ul class="uk-navbar-nav">
				        ...
				        <li class="uk-parent"><a href="#">UA-Бюджет<img src="../img/ua-budget-icon.png" style="max-width: 20px; margin-left: 5px;"></a></li>
				        <li class="uk-parent">
					        ...
					        <ul class="uk-nav uk-nav-default uk-nav-parent-icon" uk-nav="multiple: true">
					            ...
					            <li class="uk-parent">
					            	...
					            	<ul class="uk-nav-sub">
					                    ...
					                    <li><a href="ip-call.php">IP-телефонія</a></li>
					                    <li><a href="os.php">Операційні системи</a></li>
					                    <li><a href="accounting-automation.php">Офісні програми</a></li>
					                </ul>
					            </li>
					            <li><a href="#">UA-Бюджет</a></li>
					            <li class="uk-parent">
					            	<a href="#">Послуги</a>
					            	<ul class="uk-nav-sub ">
					                    <li><a href="#">Сервісна підтримка</a></li>
		...
		<div class="uk-section">
			<h1 class="uk-text-center"><img src="../img/ua-budget-icon.png" class="uk-logo">UA-Бюджет</h1>

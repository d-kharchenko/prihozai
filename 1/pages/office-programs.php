...
<body>
	<div class="uk-container" id="top-block" data-request="title=task">
				        ...
				        <li class="uk-parent">
							...
							<div class="uk-navbar-dropdown header-nav">
				                <ul class="uk-nav uk-navbar-dropdown-nav">
				                    ...
				                    <li><a href="#">Офісні програми</a></li>
				                </ul>
				            </div>
				        </li>
		...
		<div class="uk-section">
			<h1 class="uk-text-center">Офісні програми</h1>
		</div>
		<ul class="show-row uk-list uk-list-striped" uk-accordion>
